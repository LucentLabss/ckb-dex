...
The current scope supports full xUDT sell and buy orders only with auto trade matching (matching buy and sell orders). Partial fills, market orders, and multi-order atomic matching are outside the proof-of-concept contract scope.
